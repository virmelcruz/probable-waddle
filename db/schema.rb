...
ActiveRecord::Schema.define(version: 20170918230932) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["receiveable_type", "receiveable_id"], name: "index_messages_on_receiveable_type_and_receiveable_id"
  end
